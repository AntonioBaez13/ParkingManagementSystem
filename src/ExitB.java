...
public class ExitB 
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		System.out.println(
				"The Exit B has succesfully initialised client and IO connections to the parking on the socket "
						+ portNumber);
		System.out.println("REPRESENT A CAR LEAVING EXIT-B BY TYPING IN THE CONSOLE THE LETTER 'l'");
		...
		while (true) 
		{
			if (stdIN.readLine().equalsIgnoreCase("l")) 
			{
				...
				System.out.println("Exit-B : " + parkingResponse);
			} else 
			{
