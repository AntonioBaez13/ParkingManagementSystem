...
public class EntranceB 
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		System.out.println(
				"The Entrance-B has succesfully initialised client and IO connections to the parking on the socket "
						+ portNumber);
		System.out.println("REPRESENT A CAR ARRIVING ON ENTRANCE-B BY TYPING IN THE CONSOLE THE LETTER 'a'");
		...
		while (true) 
		{
			...
			{
				carsWaiting++;
				System.out.println("Entrance-B : A car has arrived");
			} else 
			{
			...
			while (carsWaiting > 0) 
			{
				...
				{
					carsWaiting--;
					System.out.println("Entrance-B : A car has entered the parking and there is/are " + carsWaiting
							+ " cars waiting to enter");
				} else if (parkingResponse.equalsIgnoreCase("There is no space")) 
				{
					System.out.println("Entrance-B : There is no space in the parking, and there is/are " + carsWaiting
							+ " cars waiting to enter");
				}
				...
				{
					System.out.println("CAR ARRIVAL IS REPRESENTED BY LETTER 'a'");
				}
			}
		}
	}
